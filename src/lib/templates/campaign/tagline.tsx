  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', width, height, backgroundColor: CANADA_COLORS.bg, padding: `${120 * scale}px ${80 * scale}px` }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        ...
        <span style={{ fontSize: 52 * scale, fontWeight: 700, color: COLORS.ignite, fontFamily: 'Plus Jakarta Sans', lineHeight: 1.3, textAlign: 'center', marginTop: 16 * scale }}>
          {v('line3', 2)}
        </span>
  ...
  return (
    <div className="flex flex-col w-full aspect-auto h-full rounded-lg items-center" style={{ backgroundColor: CANADA_COLORS.bg, padding: '2rem 1.5rem' }}>
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center">
        ...
        <span className="text-2xl font-bold leading-tight mt-1" style={{ color: COLORS.ignite }}>{v('line3', 2)}</span>
